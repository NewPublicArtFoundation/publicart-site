...
const HomepageHeading = ({ mobile }) => (
  <Container text style={{
    ...
    <Header
      as='h2'
      content='Public Art is a project to preserve street art online for the future; making it searchable and citable.'
      inverted
      style={{
    ...
    <Header
      as='h2'
      content='Help build the genealogy of street art.'
      inverted
      style={{
        fontSize: mobile ? '1.5em' : '1.7em',
        fontWeight: 'normal',
    ...
    <Grid stackable verticalAlign='middle'>
      <Grid.Row>
        ...
        <Input action={{ color: 'orange', labelPosition: 'right', icon: 'mail', content: 'Subscribe' }} placeholder='Search...' />
        </Grid.Column>
        <Grid.Column width={6}>
        </Grid.Column>
      </Grid.Row>
      ...
      <Responsive getWidth={getWidth} minWidth={Responsive.onlyTablet.minWidth}>
        ...
        >
          <Segment
            inverted
            textAlign='center'
            style={{ minHeight: 700, padding: '1em 0em', backgroundImage: 'url(/maps.jpg)', backgroundColor: '#111', backgroundSize: 'cover' }}
            vertical
          >
            <Menu
            ...
            <div>
              {users.map(user => (
                ...
                <Popup
                  ...
                  trigger={<Image size='small' src={user.avatar} avatar />}
                  header={user.name}
                  content={user.bio}
                />
                </a>
    ...
    <Segment style={{ padding: '8em 0em' }} vertical>
      ...
      <Grid columns={2} divided container doubling stackable>
        <Grid.Column>
          ...
          />
            <p>
            Emergent Ventures, a new fellowship and grant program from the Mercatus Center, seeks to support entrepreneurs and brilliant minds with highly scalable, “zero to one” ideas for meaningfully improving society.</p>
            <Button href="https://marginalrevolution.com/marginalrevolution/2018/11/emergent-ventures-grant-recipients.html" as='a' size='small'>
            Read More
          </Button>
            </Grid.Column>
        <Grid.Column>
        ...
        <p>
        Pioneer funds ambitious people around the world working on interesting projects. Unlike a startup accelerator, this is focused on small projects, not companies. A project could be anything -- open source work, research in physics or biology, or creating art.
        </p>
